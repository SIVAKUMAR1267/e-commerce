...
// 1. THE ACTUAL WORKING CONTENT (Wrapped inside Suspense boundary)
...
// 2. THE MAIN EXPORT (Next.js compilation engine reads this first)
export default function OrderSuccessPage() {
  return (
    <Suspense 
      fallback={
        <div className="min-h-screen bg-neo-bg bg-halftone flex items-center justify-center p-6">
          <div className="bg-white border-8 border-black p-12 shadow-neo-xl rotate-1 text-center max-w-lg w-full">
            <h1 className="text-4xl font-black uppercase tracking-tighter animate-pulse">
              LOADING MANIFEST...
            </h1>
          </div>
        </div>
